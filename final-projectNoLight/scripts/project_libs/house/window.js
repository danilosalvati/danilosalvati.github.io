createDoubleWindow = function(width,height,thickness,x,y,z) {
...
createGlass = function (width,height,thickness,frame1_width,frame2_thickness,includeHolder){
    ...
    /* Creo la finestra vera e propria */
    var objectWindow = new THREE.Object3D();

	var glassGeometry = new THREE.BoxGeometry(width-frame1_width*2,height/2,thickness-2*frame2_thickness);
...
createSingleWindow = function(width,height,thickness,x,y,z, includeHolder) {
	/* Questa funzione crea un singolo vetro della porta */
    ...
    /* Creo la finestra vera e propria */
    var objectWindow = createGlass(width,height,thickness,frame1_width,frame2_thickness,includeHolder);
