...
THREEx.DayNight.StarField	= function(){
	// create the mesh
	var texture	= THREE.ImageUtils.loadTexture('images/textures/galaxy_starfield.png')
	var material	= new THREE.MeshBasicMaterial({
		map	: texture,
		side	: THREE.BackSide,
 		color	: 0x808080,
	})
	var geometry	= new THREE.BoxGeometry(100,100,100, 32, 32)
...
THREEx.DayNight.SunSphere	= function(){
	...
	this.update	= function(sunAngle){
		...
		if( phase === 'day' ){
			...
			mesh.material.color.set("rgb(255,255,255)");
		}
	}
}
